    ...
    if wants_to_play == "yes":
        ...
        if left_or_right == "right":
            ...
            if ans == "around":
                ...
                print(
                    "You manage to get across, but were bit by a fish and lost 5 health.")
                health -= 5
            ans = input(
                "you notice a house and a river. Which do you go to (river/house)?\n")
            if ans == "house":
                print(
                    "You go to the house and greeted by the owner... He doesn't like you and you lose 5 health")
                health -= 5
                if health <= 0:
                    print("You now have 0 healht and you lose the game...")
                else:
